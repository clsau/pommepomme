...
<head>
    ...
    <script src="js/javanous/add_line_to_order.js"></script>
</head>
                ...
                <div id="owl-demo" class="owl-carousel">
                    <div class="item-owl">
                        <div class="test-review">
                            <div class="img-agile">
                                <img src="images/apple.png" class="img-responsive" alt=""/>
                            </div>
                        </div>
                    </div>
                    <div class="item-owl">
                        <div class="test-review">
                            <div class="img-agile">
                                <img src="images/banana.png" class="img-responsive" alt=""/>
                            </div>
                        </div>
                    </div>
                    <div class="item-owl">
                        <div class="test-review">
                            <div class="img-agile">
                                <img src="images/lemon.png" class="img-responsive" alt=""/>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <?php $i = 1;
                            while ($donnees = mysqli_fetch_array($request)) { ?>
                                ...
                                <div class="col-md-3 item g1">
                                    <a href="affiche_profil.php?produit_user_id=<?php echo $donnees['user_id']; ?>">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="lemon" aria-labelledby="lemon-tab">
                        ...
                        <div class="col-md-3 w3layouts_gallery_grid">
                            <a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est."
                               href="images/g19.jpg">
                                <div class="w3layouts_team_grid">
                                    <img src="images/g19.jpg" alt=" " class="img-responsive">
                                    <div class="w3layouts_team_grid_pos">
                                        <div class="wthree_text">
                                            <h4>Citron</h4>
                                            <p>Bonne Qualité</p>
                        ...
                        <div class="col-md-3 w3layouts_gallery_grid">
                            <a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est."
                               href="images/g20.jpg">
                                <div class="w3layouts_team_grid">
                                    <img src="images/g20.jpg" alt=" " class="img-responsive">
                                    <div class="w3layouts_team_grid_pos">
                                        <div class="wthree_text">
                                            <h4>Citron</h4>
                                            <p>Bonne Qualité</p>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="Strawberry" aria-labelledby="Strawberry-tab">
                        ...
                        <div class="col-md-3 w3layouts_gallery_grid">
                            <a title="Donec sapien massa, placerat ac sodales ac, feugiat quis est."
                               href="images/g26.jpg">
                                <div class="w3layouts_team_grid">
                                    <img src="images/g26.jpg" alt=" " class="img-responsive">
                                    <div class="w3layouts_team_grid_pos">
                                        <div class="wthree_text">
                                            <h4>Fraises</h4>
                                            <p>Aussi belles que bonnes</p>
