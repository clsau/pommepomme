...
if (isset($_GET['recherche'])) {
             "SELECT * FROM users WHERE user_code_postal_id=(select code_postal_id From code_postal where code_postal_departement_id='" . $departement . "')"); // le htmlentities() passera les guillemets en entités HTML, ce qui empêchera les injections SQL
